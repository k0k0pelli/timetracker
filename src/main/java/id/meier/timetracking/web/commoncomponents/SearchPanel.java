...
public class SearchPanel extends VerticalLayout  implements KeyNotifier {
	...
	public SearchPanel(ManageProjectStructureController manageProjectStructureController, LocaleRetriever localeRetriever) {
    	this.changeListener = new ArrayList<>();
		ComboBoxProvider<Project> projectProvider = new ComboBoxProvider<>(Project.class, manageProjectStructureController::getProjects);
