...
import id.meier.timetracking.application.port.in.assignmentmangement.ReportGeneratorUseCase;
import id.meier.timetracking.application.services.comparator.AssignmentProjectPhaseTaskComparator;
...
import id.meier.timetracking.web.reporting.ReportDefinitionFactory;
import net.sf.jasperreports.engine.*;
import net.sf.jasperreports.engine.data.JRBeanCollectionDataSource;
import org.springframework.core.env.Environment;
import id.meier.timetracking.application.services.comparator.*;
...
public class ReportGeneratorService implements ReportGeneratorUseCase {
    ...
    private final AssignmentDailyWorkAggregatorService workingPeriodAggregator;
    private final Environment environment;
    private final LocaleRetriever localeRetriever;

    public ReportGeneratorService(AssignmentProjectPhaseTaskComparator projectPhaseTaskComparator,
                           ...
                           LocaleRetriever localeRetriever,
                                  AssignmentDailyWorkAggregatorService workingPeriodAggregator) {
